...
var IndecisionApp = function (_React$Component) {
    ...
    function IndecisionApp(props) {
        ...
        _this.hasOptionsFunc = _this.hasOptionsFunc.bind(_this);
...
var Options = function Options(props) {
    return React.createElement(
        ...
        'Options:',
        props.options.map(function (i, index) {
            return React.createElement(Option, { key: index, optionText: i });
        })
    );
};
